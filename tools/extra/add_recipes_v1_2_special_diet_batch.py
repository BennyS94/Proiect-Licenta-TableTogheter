...
def _recipes() -> list[dict[str, Any]]:
    ...
    vegetarian = [
        ...
        ("Fresh Cheese Banana Oat Bowl", "snack", ["snack"], 3, 0, _snack_steps(), [i("Fresh cheese 0% fat", "drained_soft_fresh_cheese_0_fat", 180, "dairy"), i("Raw oats", "oat_raw", 90, "carb_source"), i("Banana", "banana_pulp_raw", 180, "fruit"), i("Honey", "honey", 20, "sweetener")]),

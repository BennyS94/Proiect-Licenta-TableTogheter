...
SUMMARY_PATH = PROJECT_ROOT / ".codex_runtime_logs/checks/recipesdb/mobile_m6_structure_summary.txt"
...
CONTENT_MARKERS = {
    ...
    "src/screens/HomeScreen.tsx": [
        ...
        "createSavedProfile",
        "buildSavedProfileGenerateRequest",
        "member_profile_id",
        "Selected source",
    ],
    "src/services/apiClient.ts": [
...
def main() -> int:
    ...
    summary_lines = [
        "Mobile M6 structure smoke summary",
        ...
        "components=profile_card,profile_form",
        "flow=load_saved_profiles,create_profile,select_saved_profile,generate_with_member_profile_id",
        "endpoints=GET /profiles,POST /profiles,GET /profiles/{member_profile_id}",
